...
<form method="POST" action="{{ route('admin.settings.update') }}" x-data="settingsForm()">
 ...
 {{-- Umum --}}
 <div class="card mb-4">
 <div class="card-header bg-white"><h6 class="mb-0 fw-semibold"><i class="bi bi-globe me-2 text-primary"></i>Umum</h6></div>
 <div class="card-body">
 <div style="max-width:400px">
 <label for="site_name" class="form-label fw-medium">Nama Website</label>
 <input type="text" name="site_name" id="site_name" value="{{ old('site_name', $settings['site_name']) }}" class="form-control" placeholder="Nama Toko">
 <div class="form-text">Nama yang tampil di sidebar, title halaman, dan footer.</div>
 </div>
 </div>
 </div>
