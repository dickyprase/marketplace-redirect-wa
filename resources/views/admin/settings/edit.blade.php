...
@section('content')
<div class="mb-4">
 <h4 class="fw-bold mb-1">WA Settings</h4>
 <p class="text-muted small mb-0">Konfigurasi nomor WhatsApp admin dan template pesan checkout</p>
</div>
...
<form method="POST" action="{{ route('admin.settings.update') }}" x-data="settingsForm()">
  ...
  <div class="card-body vstack gap-4">
   ...
   <div class="row g-4">
    <div class="col-lg-6">
      ...
      <div class="form-text mt-2">Styling WA: <code>*tebal*</code> <code>_miring_</code> <code>~coret~</code> <code>```mono```</code></div>
    </div>
    <div class="col-lg-6">
 ...
 <div class="d-flex gap-2">
  <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i> Simpan WA Setting</button>
